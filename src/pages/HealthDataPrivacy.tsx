    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-6 py-16 md:py-20 border-b border-border/60 bg-card/30">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xs font-semibold uppercase tracking-widest text-primary mb-3">Last Updated: April 2025 · Version 1.0</p>
            ...
            <CardContent className="p-0">
              <Table>
                <TableBody>
                  ...
                  <TableRow><TableCell className="font-medium">Last Updated</TableCell><TableCell>April 2025</TableCell></TableRow>
