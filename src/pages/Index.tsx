    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <footer className="px-6 py-16 border-t border-border/60">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10 text-sm">
          ...
          <div className="space-y-3">
            <a href="#" className="block text-primary hover:opacity-80">Safety Policy &amp; Community Guidelines</a>
            <a href="#" className="block text-primary hover:opacity-80">Compliance</a>
          ...
          <div className="space-y-3">
            <a href="#" className="block text-primary hover:opacity-80">Online Safety Code</a>
            <a href="#" className="block text-primary hover:opacity-80">Open Source Licenses</a>
            <a href="#" className="block text-primary hover:opacity-80">Privacy Policy</a>
