...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <PageMeta
        title="GoMilap — Nice to meet you | Chat, Connect & Belong"
        description="GoMilap is a modern social platform to discover people nearby, chat in real time, and build genuine connections. Free to join. Available in India."
        keywords="GoMilap, social chat app, meet new people, chat app India, video chat, make new friends, social platform India"
      ...
      <footer className="px-6 py-16 border-t border-border/60">
        <div className="max-w-6xl mx-auto grid gap-10 text-sm md:grid-cols-[1.2fr_1fr_1fr]">
          ...
          <div className="space-y-3">
            ...
            <Link to="/blog" className="block text-primary hover:opacity-80">Blog</Link>
          </div>
